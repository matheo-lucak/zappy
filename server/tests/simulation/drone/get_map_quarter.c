...
Test(drone_get_map_quarter, simple_get_top_left_corner)
{
    ...
    cr_expect(drone_get_map_quarter(map, drone) == MAP_TOP_LEFT);
    drone_destroy(drone);
    map_destroy(map);
}
...
Test(drone_get_map_quarter, simple_get_top_right_corner)
{
    ...
    cr_expect(drone_get_map_quarter(map, drone) == MAP_TOP_RIGHT);
    drone_destroy(drone);
    map_destroy(map);
}
...
Test(drone_get_map_quarter, simple_get_bottom_left_corner)
{
    ...
    cr_expect(drone_get_map_quarter(map, drone) == MAP_BOTTOM_LEFT);
    drone_destroy(drone);
    map_destroy(map);
}
...
Test(drone_get_map_quarter, simple_get_bottom_right_corner)
{
    ...
    cr_expect(drone_get_map_quarter(map, drone) == MAP_BOTTOM_RIGHT);
    drone_destroy(drone);
    map_destroy(map);
}
